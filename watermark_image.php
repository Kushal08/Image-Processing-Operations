...
<div >
  <h2>File Upload</h2>
  <form name="imageUpload" action = "wimage.php" method="post" enctype="multipart/form-data" >
    <table align="center"  >
	  <tr>
	  ...
	  <tr>
	     <td><label for="file">Upload Image File:</label></td>
		<td><input type="file" name="imgfile1" id="file" /></td>
	  </tr>
	  <tr>
	    <td></td>
		<td><br/><input type="submit" name="createmark" value="Submit" /></td>
	  </tr>
	<table>
 </form>
